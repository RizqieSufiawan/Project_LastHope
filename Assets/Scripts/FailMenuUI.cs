...
{
    public static FailMenuUI Instance { get; private set; }

    [Header("Panel")]
    public GameObject panel;
    [Tooltip("Full-screen black (or dark) Image, alpha 0 at rest.")]
    ...
    public void Show(string message)
    {
        ...
        if (panel == null)
        {
            Debug.LogWarning("FailMenuUI: panel not assigned");
            return;
        }
    ...
    private IEnumerator FadeInRoutine()
    {
        ...
        {
            timer += Time.unscaledDeltaTime; // unscaled — keeps animating while timeScale = 0
